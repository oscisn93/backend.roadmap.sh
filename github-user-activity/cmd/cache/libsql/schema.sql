...
CREATE TABLE IF NOT EXISTS ref_create (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  ref TEXT,
...
CREATE TABLE IF NOT EXISTS gollum (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS team_add (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_actor_id_event_type ON event (actor_id, type);

CREATE INDEX IF NOT EXISTS idx_event_created_at ON event (created_at);

CREATE INDEX IF NOT EXISTS idx_actor_login ON actor (login);

CREATE INDEX IF NOT EXISTS idx_repo_name ON repo (name);

CREATE INDEX IF NOT EXISTS idx_commit_payload_id ON commit (payload_id);
